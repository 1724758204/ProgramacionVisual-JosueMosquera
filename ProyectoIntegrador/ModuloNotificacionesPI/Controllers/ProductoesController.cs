...
namespace ModuloNotificacionesPI.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Nombre,Precio,FechaRegistro,UsuarioId")] Producto producto)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "UsuarioId", "Nombre", producto.UsuarioId);
            return View(producto);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "UsuarioId", "UsuarioId", producto.UsuarioId);
            return View(producto);
        }
